...
export { withSentry, withSentryAPI } from './config/wrappers/withSentryAPI.js';
...
function addServerIntegrations(options) {
  ...
  var defaultRequestDataIntegration = new Integrations.RequestData();
