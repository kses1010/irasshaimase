...
import { withErrorInstrumentation, callTracedServerSideDataFetcher } from './wrapperUtils.js';
...
function withSentryServerSideDocumentGetInitialProps(
  ...
  return async function (
    ...
    var errorWrappedGetInitialProps = withErrorInstrumentation(origDocumentGetInitialProps);
...
export { withSentryServerSideDocumentGetInitialProps };
