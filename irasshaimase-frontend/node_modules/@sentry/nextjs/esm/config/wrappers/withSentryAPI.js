...
function withSentry(origHandler, parameterizedRoute) {
  ...
  return async function sentryWrappedHandler(req, res) {
    ...
    var boundHandler = local.bind(async () => {
      let transaction;
      ...
      if (currentScope) {
        ...
        if (hasTracingEnabled()) {
          ...
          if (req.headers && isString(req.headers['sentry-trace'])) {
            ...
            (typeof __SENTRY_DEBUG__ === 'undefined' || __SENTRY_DEBUG__) && logger.log(`[Tracing] Continuing trace ${_optionalChain([traceparentData, 'optionalAccess', _ => _.traceId])}.`);
          }

          var baggageHeader = req.headers && req.headers.baggage;
      ...
      try {
        var handlerResult = await origHandler(req, res);
        ...
        var objectifiedErr = objectify(e);
...
export { withSentry, withSentryAPI };
//# sourceMappingURL=withSentryAPI.js.map
