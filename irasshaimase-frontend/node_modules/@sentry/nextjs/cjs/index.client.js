...
function createClientIntegrations(userIntegrations$1 = []) {
  ...
  return userIntegrations.addOrUpdateIntegration(defaultBrowserTracingIntegration, userIntegrations$1, {
    'options.routingInstrumentation': client.nextRouterInstrumentation,
  });
}
