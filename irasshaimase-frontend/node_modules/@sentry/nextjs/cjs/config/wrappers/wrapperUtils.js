...
var responseEnd = require('./utils/responseEnd.js');
...
,
  ...
  return domain.create().bind(async () => {
    ...
    if (requestTransaction === undefined) {
      ...
      var dynamicSamplingContext = utils.baggageHeaderToDynamicSamplingContext(rawBaggageString);
