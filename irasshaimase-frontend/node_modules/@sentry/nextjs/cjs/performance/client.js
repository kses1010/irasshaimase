...
function nextRouterInstrumentation(
  ...
  if (startTransactionOnPageLoad) {
    ...
    var dynamicSamplingContext = utils.baggageHeaderToDynamicSamplingContext(baggage);
  ...
  if (startTransactionOnLocationChange) {
    Router.default.events.on('routeChangeStart', (navigationTarget) => {
      var matchedRoute = getNextRouteFromPathname(utils.stripUrlQueryAndFragment(navigationTarget));
